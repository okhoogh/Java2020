...
<html lang="zh-CN">
    ...
    <body>
        ...
        <form action="${pageContext.request.contextPath}/updateUserServlet" method="post" id="formUpdate">
          ...
          <div class="form-group has-warning">
            ...
            <input type="email" class="form-control" name="email" placeholder="请输入邮箱地址" id="email" value="${user.email}"/>
          </div>
