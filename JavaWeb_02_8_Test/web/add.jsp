...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/addUserServlet" method="post" id="formAdd">
        <div class="form-group" id="nameDiv">
            <label for="name">姓名：</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="请输入姓名">
            <span class="" aria-hidden="true" id="nameSpan"></span>
        </div>
        ...
        <div class="form-group" id="ageDiv">
            ...
            <span class="" aria-hidden="true" id="ageSpan" ></span>
        </div>
        ...
        <div class="form-group " style="text-align: center">
            ...
            <input class="btn btn-default" type="button" value="返回" id="btnBack"/>
        </div>
    </form>
</div>
</body>
